...
function (Okta, Q, Backbone, SharedUtil, CryptoUtil, Logger, DevLogger, OktaAuth, Util, Expect, Router,
  ...
  Expect.describe('LoginRouter', function () {
    ...
    itp('uses a default globalSuccessFn if a globalSuccessFn is not passed as a widget param', function () {
    ...
    itp('uses a default globalErrorFn if value is not passed as widget param', function () {
